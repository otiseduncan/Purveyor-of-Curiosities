      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            ...
            >
              <div className="mb-6 inline-flex h-12 min-w-12 items-center justify-center rounded-2xl border border-gold/40 bg-gold/10 px-3 text-[10px] font-black uppercase tracking-wider text-gold">
                {category.code}
              </div>
